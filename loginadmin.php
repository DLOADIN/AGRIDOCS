...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "SELECT * FROM `business` WHERE u_name = '$name' AND u_password = '$password'");
    ...
    if (mysqli_num_rows($sql) > 0) {
        if ($password === $query["u_password"]) {
            ...
            $logSql = "INSERT INTO login_logs (user_id, login_time) VALUES ('$userId', '$loginTime')";
