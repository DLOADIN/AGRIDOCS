    ...
    <h1>CERTIFICATE OF ORIGIN</h1>
      <div class="fire-table">
        ...
        <form action="" method="post" class="la-form">
          ...
          <div class="ibex">
          <label for="">CERTIFICATE OF ORIGIN</label>
          </div>

          <div class="ibex" id="ibex">
            <input type="text" name="foreignid" value="<?php echo $gat;?>">
            <input type="text" name="u_importer" placeholder="IMPORTER">
          ...
          <div class="ibex" id="ibex">
          <h1>DESCRIPTION OF GOODS</h1>
            <div class="frat-frat">
              <input type="text" name="u_tariffcode" placeholder="HARMONIZED TARIFF CODE">
              <input type="text" name="u_goods" placeholder="DESCRIPTION OF GOODS">
              <input type="text" name="u_country" placeholder="COUNTRY OF ORIGIN">
            </div><br><br>
            <label for="">PRODUCTION DATE</label><br>
            <input type="date" name="u_productiondate" placeholder="COUNTRY OF ORIGIN"><br><br><br>
            <label for="">EXPIRATION DATE</label><br>
            <input type="date" name="u_expirationdate" placeholder="COUNTRY OF ORIGIN">
          </div>
          <div class="ibex" id="ibex">
...
<?php
  if(isset($_POST['submit'])){
    ...
    $u_tariffcode = $_POST['u_tariffcode'];
    $u_goods = $_POST['u_goods'];
    $u_country = $_POST['u_country'];
    $u_productiondate = $_POST['u_productiondate'];
    $u_expirationdate = $_POST['u_expirationdate'];
    $status = $_POST['status'];
    $sql=mysqli_query($con,"INSERT INTO `certificate` VALUES('','$foreignid','$u_importer','$u_exporter','$u_tariffcode','$u_goods','$u_country','$u_productiondate','$u_expirationdate', '$status')");
